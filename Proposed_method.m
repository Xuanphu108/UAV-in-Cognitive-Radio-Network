...
fid_SercrecyRate_Threshold = fopen('..\UAV\Output\Threshold\SecrecyRate_Iteration\Proposed_method\Secrecy_Rate.txt','w');
fid_Iteration_Threshold = fopen('..\UAV\Output\Threshold\SecrecyRate_Iteration\Proposed_method\Iteration.txt','w');


%%%%%%%%%%%%%%%%%%%%%%%%%% - SecrecyRate_Time - %%%%%%%%%%%%%%%%%%%%%%%%%%%
fid_SecrecyRate = fopen('..\UAV\Output\SecrecyRate_Time\Proposed_method\Secrecy_Rate.txt','w');%
fid_Time = fopen('..\UAV\Output\SecrecyRate_Time\Proposed_method\Time.txt','w');

fid_y_1 = fopen('..\UAV\Output\Trajectory\Proposed_method\y_1.txt','w');
fid_ht_1 = fopen('..\UAV\Output\Trajectory\Proposed_method\ht_1.txt','w');
fid_x_2 = fopen('..\UAV\Output\Trajectory\Proposed_method\x_2.txt','w');
fid_y_2 = fopen('..\UAV\Output\Trajectory\Proposed_method\y_2.txt','w');
fid_ht_2 = fopen('..\UAV\Output\Trajectory\Proposed_method\ht_2.txt','w');
fid_x_3 = fopen('..\UAV\Output\Trajectory\Proposed_method\x_3.txt','w');
fid_y_3 = fopen('..\UAV\Output\Trajectory\Proposed_method\y_3.txt','w');
fid_ht_3 = fopen('..\UAV\Output\Trajectory\Proposed_method\ht_3.txt','w');
fid_x_4 = fopen('..\UAV\Output\Trajectory\Proposed_method\x_4.txt','w');
fid_y_4 = fopen('..\UAV\Output\Trajectory\Proposed_method\y_4.txt','w');
fid_ht_4 = fopen('..\UAV\Output\Trajectory\Proposed_method\ht_4.txt','w');
fid_x_5 = fopen('..\UAV\Output\Trajectory\Proposed_method\x_5.txt','w');
fid_y_5 = fopen('..\UAV\Output\Trajectory\Proposed_method\y_5.txt','w');
fid_ht_5 = fopen('..\UAV\Output\Trajectory\Proposed_method\ht_5.txt','w');
fid_x_6 = fopen('..\UAV\Output\Trajectory\Proposed_method\x_6.txt','w');
fid_y_6 = fopen('..\UAV\Output\Trajectory\Proposed_method\y_6.txt','w');
fid_ht_6 = fopen('..\UAV\Output\Trajectory\Proposed_method\ht_6.txt','w');
fid_x_7 = fopen('..\UAV\Output\Trajectory\Proposed_method\x_7.txt','w');
fid_y_7 = fopen('..\UAV\Output\Trajectory\Proposed_method\y_7.txt','w');
fid_ht_7 = fopen('..\UAV\Output\Trajectory\Proposed_method\ht_7.txt','w');
fid_x_8 = fopen('..\UAV\Output\Trajectory\Proposed_method\x_8.txt','w');
fid_y_8 = fopen('..\UAV\Output\Trajectory\Proposed_method\y_8.txt','w');
fid_ht_8 = fopen('..\UAV\Output\Trajectory\Proposed_method\ht_8.txt','w');

fid_PowerSource_1 = fopen('..\UAV\Output\Power_Source\Proposed_method\Power_Source_1.txt','w');
fid_TimeSlot1_1 = fopen('..\UAV\Output\Power_Source\Proposed_method\Time_Slot1.txt','w');
fid_PowerSource_2 = fopen('..\UAV\Output\Power_Source\Proposed_method\Power_Source_2.txt','w');
fid_TimeSlot1_2 = fopen('..\UAV\Output\Power_Source\Proposed_method\Time_Slot2.txt','w');
fid_PowerSource_3 = fopen('..\UAV\Output\Power_Source\Proposed_method\Power_Source_3.txt','w');
fid_TimeSlot1_3 = fopen('..\UAV\Output\Power_Source\Proposed_method\Time_Slot3.txt','w');
fid_PowerSource_4 = fopen('..\UAV\Output\Power_Source\Proposed_method\Power_Source_4.txt','w');
fid_TimeSlot1_4 = fopen('..\UAV\Output\Power_Source\Proposed_method\Time_Slot4.txt','w');
fid_PowerSource_5 = fopen('..\UAV\Output\Power_Source\Proposed_method\Power_Source_5.txt','w');
fid_TimeSlot1_5 = fopen('..\UAV\Output\Power_Source\Proposed_method\Time_Slot5.txt','w');
fid_PowerSource_6 = fopen('..\UAV\Output\Power_Source\Proposed_method\Power_Source_6.txt','w');
fid_TimeSlot1_6 = fopen('..\UAV\Output\Power_Source\Proposed_method\Time_Slot6.txt','w');
fid_PowerSource_7 = fopen('..\UAV\Output\Power_Source\Proposed_method\Power_Source_7.txt','w');
fid_TimeSlot1_7 = fopen('..\UAV\Output\Power_Source\Proposed_method\Time_Slot7.txt','w');
fid_PowerSource_8 = fopen('..\UAV\Output\Power_Source\Proposed_method\Power_Source_8.txt','w');
fid_TimeSlot1_8 = fopen('..\UAV\Output\Power_Source\Proposed_method\Time_Slot8.txt','w');

fid_PowerUAV_1 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Power_UAV_1.txt','w');
fid_TimeSlot2_1 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Time_Slot1.txt','w');
fid_PowerUAV_2 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Power_UAV_2.txt','w');
fid_TimeSlot2_2 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Time_Slot2.txt','w');
fid_PowerUAV_3 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Power_UAV_3.txt','w');
fid_TimeSlot2_3 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Time_Slot3.txt','w');
fid_PowerUAV_4 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Power_UAV_4.txt','w');
fid_TimeSlot2_4 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Time_Slot4.txt','w');
fid_PowerUAV_5 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Power_UAV_5.txt','w');
fid_TimeSlot2_5 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Time_Slot5.txt','w');
fid_PowerUAV_6 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Power_UAV_6.txt','w');
fid_TimeSlot2_6 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Time_Slot6.txt','w');
fid_PowerUAV_7 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Power_UAV_7.txt','w');
fid_TimeSlot2_7 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Time_Slot7.txt','w');
fid_PowerUAV_8 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Power_UAV_8.txt','w');
fid_TimeSlot2_8 = fopen('..\UAV\Output\Power_UAV\Proposed_method\Time_Slot8.txt','w');

fid_Rate_1 = fopen('..\UAV\Output\Rate\Proposed_method\Rate_1.txt','w');
fid_TimeSlot3_1 = fopen('..\UAV\Output\Rate\Proposed_method\Time_Slot1.txt','w');
fid_Rate_2 = fopen('..\UAV\Output\Rate\Proposed_method\Rate_2.txt','w');
fid_TimeSlot3_2 = fopen('..\UAV\Output\Rate\Proposed_method\Time_Slot2.txt','w');
fid_Rate_3 = fopen('..\UAV\Output\Rate\Proposed_method\Rate_3.txt','w');
fid_TimeSlot3_3 = fopen('..\UAV\Output\Rate\Proposed_method\Time_Slot3.txt','w');
fid_Rate_4 = fopen('..\UAV\Output\Rate\Proposed_method\Rate_4.txt','w');
fid_TimeSlot3_4 = fopen('..\UAV\Output\Rate\Proposed_method\Time_Slot4.txt','w');
fid_Rate_5 = fopen('..\UAV\Output\Rate\Proposed_method\Rate_5.txt','w');
fid_TimeSlot3_5 = fopen('..\UAV\Output\Rate\Proposed_method\Time_Slot5.txt','w');
fid_Rate_6 = fopen('..\UAV\Output\Rate\Proposed_method\Rate_6.txt','w');
fid_TimeSlot3_6 = fopen('..\UAV\Output\Rate\Proposed_method\Time_Slot6.txt','w');
fid_Rate_7 = fopen('..\UAV\Output\Rate\Proposed_method\Rate_7.txt','w');
fid_TimeSlot3_7 = fopen('..\UAV\Output\Rate\Proposed_method\Time_Slot7.txt','w');
fid_Rate_8 = fopen('..\UAV\Output\Rate\Proposed_method\Rate_8.txt','w');
fid_TimeSlot3_8 = fopen('..\UAV\Output\Rate\Proposed_method\Time_Slot8.txt','w');

fid_Distance_1 = fopen('..\UAV\Output\Distance\Proposed_method\Distance_1.txt','w');
fid_TimeSlot4_1 = fopen('..\UAV\Output\Distance\Proposed_method\Time_Slot1.txt','w');
fid_Distance_2 = fopen('..\UAV\Output\Distance\Proposed_method\Distance_2.txt','w');
fid_TimeSlot4_2 = fopen('..\UAV\Output\Distance\Proposed_method\Time_Slot2.txt','w');
fid_Distance_3 = fopen('..\UAV\Output\Distance\Proposed_method\Distance_3.txt','w');
fid_TimeSlot4_3 = fopen('..\UAV\Output\Distance\Proposed_method\Time_Slot3.txt','w');
fid_Distance_4 = fopen('..\UAV\Output\Distance\Proposed_method\Distance_4.txt','w');
fid_TimeSlot4_4 = fopen('..\UAV\Output\Distance\Proposed_method\Time_Slot4.txt','w');
fid_Distance_5 = fopen('..\UAV\Output\Distance\Proposed_method\Distance_5.txt','w');
fid_TimeSlot4_5 = fopen('..\UAV\Output\Distance\Proposed_method\Time_Slot5.txt','w');
fid_Distance_6 = fopen('..\UAV\Output\Distance\Proposed_method\Distance_6.txt','w');
fid_TimeSlot4_6 = fopen('..\UAV\Output\Distance\Proposed_method\Time_Slot6.txt','w');
fid_Distance_7 = fopen('..\UAV\Output\Distance\Proposed_method\Distance_7.txt','w');
fid_TimeSlot4_7 = fopen('..\UAV\Output\Distance\Proposed_method\Time_Slot7.txt','w');
fid_Distance_8 = fopen('..\UAV\Output\Distance\Proposed_method\Distance_8.txt','w');
fid_TimeSlot4_8 = fopen('..\UAV\Output\Distance\Proposed_method\Time_Slot8.txt','w');

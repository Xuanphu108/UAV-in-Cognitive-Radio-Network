...
Pcs_max = 10^(40/10-3); % the peak transmit power 40
...
gamma = 10^8; % gamma = beta/noise = 80dB
...
fid_SercrecyRate_Threshold = fopen('..\40m\Output\Threshold\SecrecyRate_Iteration\Proposed_method\Secrecy_Rate.txt','w');
fid_Iteration_Threshold = fopen('..\40m\Output\Threshold\SecrecyRate_Iteration\Proposed_method\Iteration.txt','w');


%%%%%%%%%%%%%%%%%%%%%%%%%% - SecrecyRate_Time - %%%%%%%%%%%%%%%%%%%%%%%%%%%
fid_SecrecyRate = fopen('..\40m\Output\SecrecyRate_Time\Proposed_method\Secrecy_Rate.txt','w');%
fid_Time = fopen('..\40m\Output\SecrecyRate_Time\Proposed_method\Time.txt','w');

fid_x_1 = fopen('..\40m\Output\Trajectory\Proposed_method\x_1.txt','w');
fid_y_1 = fopen('..\40m\Output\Trajectory\Proposed_method\y_1.txt','w');
fid_ht_1 = fopen('..\40m\Output\Trajectory\Proposed_method\ht_1.txt','w');
fid_x_2 = fopen('..\40m\Output\Trajectory\Proposed_method\x_2.txt','w');
fid_y_2 = fopen('..\40m\Output\Trajectory\Proposed_method\y_2.txt','w');
fid_ht_2 = fopen('..\40m\Output\Trajectory\Proposed_method\ht_2.txt','w');
fid_x_3 = fopen('..\40m\Output\Trajectory\Proposed_method\x_3.txt','w');
fid_y_3 = fopen('..\40m\Output\Trajectory\Proposed_method\y_3.txt','w');
fid_ht_3 = fopen('..\40m\Output\Trajectory\Proposed_method\ht_3.txt','w');
fid_x_4 = fopen('..\40m\Output\Trajectory\Proposed_method\x_4.txt','w');
fid_y_4 = fopen('..\40m\Output\Trajectory\Proposed_method\y_4.txt','w');
fid_ht_4 = fopen('..\40m\Output\Trajectory\Proposed_method\ht_4.txt','w');
fid_x_5 = fopen('..\40m\Output\Trajectory\Proposed_method\x_5.txt','w');
fid_y_5 = fopen('..\40m\Output\Trajectory\Proposed_method\y_5.txt','w');
fid_ht_5 = fopen('..\40m\Output\Trajectory\Proposed_method\ht_5.txt','w');
fid_x_6 = fopen('..\40m\Output\Trajectory\Proposed_method\x_6.txt','w');
fid_y_6 = fopen('..\40m\Output\Trajectory\Proposed_method\y_6.txt','w');
fid_ht_6 = fopen('..\40m\Output\Trajectory\Proposed_method\ht_6.txt','w');
fid_x_7 = fopen('..\40m\Output\Trajectory\Proposed_method\x_7.txt','w');
fid_y_7 = fopen('..\40m\Output\Trajectory\Proposed_method\y_7.txt','w');
fid_ht_7 = fopen('..\40m\Output\Trajectory\Proposed_method\ht_7.txt','w');
fid_x_8 = fopen('..\40m\Output\Trajectory\Proposed_method\x_8.txt','w');
fid_y_8 = fopen('..\40m\Output\Trajectory\Proposed_method\y_8.txt','w');
fid_ht_8 = fopen('..\40m\Output\Trajectory\Proposed_method\ht_8.txt','w');

fid_PowerSource_1 = fopen('..\40m\Output\Power_Source\Proposed_method\Power_Source_1.txt','w');
fid_TimeSlot1_1 = fopen('..\40m\Output\Power_Source\Proposed_method\Time_Slot1.txt','w');
fid_PowerSource_2 = fopen('..\40m\Output\Power_Source\Proposed_method\Power_Source_2.txt','w');
fid_TimeSlot1_2 = fopen('..\40m\Output\Power_Source\Proposed_method\Time_Slot2.txt','w');
fid_PowerSource_3 = fopen('..\40m\Output\Power_Source\Proposed_method\Power_Source_3.txt','w');
fid_TimeSlot1_3 = fopen('..\40m\Output\Power_Source\Proposed_method\Time_Slot3.txt','w');
fid_PowerSource_4 = fopen('..\40m\Output\Power_Source\Proposed_method\Power_Source_4.txt','w');
fid_TimeSlot1_4 = fopen('..\40m\Output\Power_Source\Proposed_method\Time_Slot4.txt','w');
fid_PowerSource_5 = fopen('..\40m\Output\Power_Source\Proposed_method\Power_Source_5.txt','w');
fid_TimeSlot1_5 = fopen('..\40m\Output\Power_Source\Proposed_method\Time_Slot5.txt','w');
fid_PowerSource_6 = fopen('..\40m\Output\Power_Source\Proposed_method\Power_Source_6.txt','w');
fid_TimeSlot1_6 = fopen('..\40m\Output\Power_Source\Proposed_method\Time_Slot6.txt','w');
fid_PowerSource_7 = fopen('..\40m\Output\Power_Source\Proposed_method\Power_Source_7.txt','w');
fid_TimeSlot1_7 = fopen('..\40m\Output\Power_Source\Proposed_method\Time_Slot7.txt','w');
fid_PowerSource_8 = fopen('..\40m\Output\Power_Source\Proposed_method\Power_Source_8.txt','w');
fid_TimeSlot1_8 = fopen('..\40m\Output\Power_Source\Proposed_method\Time_Slot8.txt','w');

fid_PowerUAV_1 = fopen('..\40m\Output\Power_UAV\Proposed_method\Power_UAV_1.txt','w');
fid_TimeSlot2_1 = fopen('..\40m\Output\Power_UAV\Proposed_method\Time_Slot1.txt','w');
fid_PowerUAV_2 = fopen('..\40m\Output\Power_UAV\Proposed_method\Power_UAV_2.txt','w');
fid_TimeSlot2_2 = fopen('..\40m\Output\Power_UAV\Proposed_method\Time_Slot2.txt','w');
fid_PowerUAV_3 = fopen('..\40m\Output\Power_UAV\Proposed_method\Power_UAV_3.txt','w');
fid_TimeSlot2_3 = fopen('..\40m\Output\Power_UAV\Proposed_method\Time_Slot3.txt','w');
fid_PowerUAV_4 = fopen('..\40m\Output\Power_UAV\Proposed_method\Power_UAV_4.txt','w');
fid_TimeSlot2_4 = fopen('..\40m\Output\Power_UAV\Proposed_method\Time_Slot4.txt','w');
fid_PowerUAV_5 = fopen('..\40m\Output\Power_UAV\Proposed_method\Power_UAV_5.txt','w');
fid_TimeSlot2_5 = fopen('..\40m\Output\Power_UAV\Proposed_method\Time_Slot5.txt','w');
fid_PowerUAV_6 = fopen('..\40m\Output\Power_UAV\Proposed_method\Power_UAV_6.txt','w');
fid_TimeSlot2_6 = fopen('..\40m\Output\Power_UAV\Proposed_method\Time_Slot6.txt','w');
fid_PowerUAV_7 = fopen('..\40m\Output\Power_UAV\Proposed_method\Power_UAV_7.txt','w');
fid_TimeSlot2_7 = fopen('..\40m\Output\Power_UAV\Proposed_method\Time_Slot7.txt','w');
fid_PowerUAV_8 = fopen('..\40m\Output\Power_UAV\Proposed_method\Power_UAV_8.txt','w');
fid_TimeSlot2_8 = fopen('..\40m\Output\Power_UAV\Proposed_method\Time_Slot8.txt','w');

fid_Rate_1 = fopen('..\40m\Output\Rate\Proposed_method\Rate_1.txt','w');
fid_TimeSlot3_1 = fopen('..\40m\Output\Rate\Proposed_method\Time_Slot1.txt','w');
fid_Rate_2 = fopen('..\40m\Output\Rate\Proposed_method\Rate_2.txt','w');
fid_TimeSlot3_2 = fopen('..\40m\Output\Rate\Proposed_method\Time_Slot2.txt','w');
fid_Rate_3 = fopen('..\40m\Output\Rate\Proposed_method\Rate_3.txt','w');
fid_TimeSlot3_3 = fopen('..\40m\Output\Rate\Proposed_method\Time_Slot3.txt','w');
fid_Rate_4 = fopen('..\40m\Output\Rate\Proposed_method\Rate_4.txt','w');
fid_TimeSlot3_4 = fopen('..\40m\Output\Rate\Proposed_method\Time_Slot4.txt','w');
fid_Rate_5 = fopen('..\40m\Output\Rate\Proposed_method\Rate_5.txt','w');
fid_TimeSlot3_5 = fopen('..\40m\Output\Rate\Proposed_method\Time_Slot5.txt','w');
fid_Rate_6 = fopen('..\40m\Output\Rate\Proposed_method\Rate_6.txt','w');
fid_TimeSlot3_6 = fopen('..\40m\Output\Rate\Proposed_method\Time_Slot6.txt','w');
fid_Rate_7 = fopen('..\40m\Output\Rate\Proposed_method\Rate_7.txt','w');
fid_TimeSlot3_7 = fopen('..\40m\Output\Rate\Proposed_method\Time_Slot7.txt','w');
fid_Rate_8 = fopen('..\40m\Output\Rate\Proposed_method\Rate_8.txt','w');
fid_TimeSlot3_8 = fopen('..\40m\Output\Rate\Proposed_method\Time_Slot8.txt','w');

fid_Distance_1 = fopen('..\40m\Output\Distance\Proposed_method\Distance_1.txt','w');
fid_TimeSlot4_1 = fopen('..\40m\Output\Distance\Proposed_method\Time_Slot1.txt','w');
fid_Distance_2 = fopen('..\40m\Output\Distance\Proposed_method\Distance_2.txt','w');
fid_TimeSlot4_2 = fopen('..\40m\Output\Distance\Proposed_method\Time_Slot2.txt','w');
fid_Distance_3 = fopen('..\40m\Output\Distance\Proposed_method\Distance_3.txt','w');
fid_TimeSlot4_3 = fopen('..\40m\Output\Distance\Proposed_method\Time_Slot3.txt','w');
fid_Distance_4 = fopen('..\40m\Output\Distance\Proposed_method\Distance_4.txt','w');
fid_TimeSlot4_4 = fopen('..\40m\Output\Distance\Proposed_method\Time_Slot4.txt','w');
fid_Distance_5 = fopen('..\40m\Output\Distance\Proposed_method\Distance_5.txt','w');
fid_TimeSlot4_5 = fopen('..\40m\Output\Distance\Proposed_method\Time_Slot5.txt','w');
fid_Distance_6 = fopen('..\40m\Output\Distance\Proposed_method\Distance_6.txt','w');
fid_TimeSlot4_6 = fopen('..\40m\Output\Distance\Proposed_method\Time_Slot6.txt','w');
fid_Distance_7 = fopen('..\40m\Output\Distance\Proposed_method\Distance_7.txt','w');
fid_TimeSlot4_7 = fopen('..\40m\Output\Distance\Proposed_method\Time_Slot7.txt','w');
fid_Distance_8 = fopen('..\40m\Output\Distance\Proposed_method\Distance_8.txt','w');
fid_TimeSlot4_8 = fopen('..\40m\Output\Distance\Proposed_method\Time_Slot8.txt','w');
...
while (1)
    ...
    for i = 1:1:15        
        ...
        %R_old=R_new;
        cvx_begin sdp
            variables R_cvx(1,N) Pu_cvx(1,N) Pcs_cvx(1,N) x_cvx(1,N) y_cvx(1,N) ht_cvx(1,N); 
            ...
            subject to
                ...
                norm([(x_cvx(1)-x0) (y_cvx(1)-y0) (ht_cvx(1)-ht0)]) <= T_flight*V/N;
                80 <= ht_cvx(1) <= 180
                for n = 1:1:N-1
                    norm([(x_cvx(n+1)-x_cvx(n)) (y_cvx(n+1)-y_cvx(n)) (ht_cvx(n+1)-ht_cvx(n))]) <= T_flight*V/N;
                    80 <= ht_cvx(n) <= 180
                end
                x_cvx(N) == xF;
                y_cvx(N) == yF;
                ...
                % (1/N)*sum(beta*d_cs_pu*Pcs_cvx(1,1:N)+c_cvx(1,1:N)) <= 10^(-5);%5,6,7 standard 5
                ...
                for n = 1:1:N
                    ...
                    % z_cvx(n) <= (x_cu-x_initial(n))^2 + 2*(x_initial(n)-x_cu)*(x_cvx(n)-x_initial(n)) + (y_initial(n))^2 + 2*y_initial(n)*(y_cvx(n)-y_initial(n)) + ...
                    ...
                    [(epsilon_cvx_e(n)-1) 0 (x_cvx(n)-x_e);...
                     0 (epsilon_cvx_e(n)-1) (y_cvx(n)-y_e);... 
                     (x_cvx(n)-x_e) (y_cvx(n)-y_e) (-Qe^2*epsilon_cvx_e(n)-schur_cvx_e(n))] >= 0;
                    epsilon_cvx_e(n) >= 0;
                    norm([(x_cvx(n)-x_e) (y_cvx(n)-y_e) (ht_cvx(n)-ht_e) (1/2)*(k_cvx(n)+schur_cvx_e(n)-1)]) <= (1/2)*(k_cvx(n)+schur_cvx_e(n)+1);
                    % norm([(-x_e+x_cvx(n)) (-y_e+y_cvx(n)) ht_cvx(n) (1/2)*(k_cvx(n)-1)]) <= (1/2)*(k_cvx(n)+1); % k(n) >= (x_e-x(n))^2+(y_e-y(n))^2+H^2,
                    ...
                    norm([v_cvx(n)*sqrt(0.5*B(n)) k_cvx(n)*sqrt(0.5/B(n)) 0.5*(Pu_cvx(n)-1)*sqrt(gamma)]) <= 0.5*(Pu_cvx(n)+1)*sqrt(gamma);
                    ...
                    beta*d_cs_pu*Pcs_cvx(n) + c_cvx(n) <= 10^(-5);
        ...
        hold on
        subplot(4,1,1)
        plot(a(1,1:N),Pu_initial_1(1,1:N));
        ...
        %{
        subplot(4,1,2)
        plot(a(1,1:N),((x_initial-x_k).^2+(y_initial-y_k).^2+(ht_initial-ht_k).^2).^(1/2));
        ...
        subplot(4,1,3)
        plot(a(1,1:N),Pcs_initial_1(1,1:N));

...
fid_SercrecyRate_Threshold = fopen('..\40m\Output\Threshold\SecrecyRate_Iteration\Optimize_Trajectory\Secrecy_Rate.txt','w');
fid_Iteration_Threshold = fopen('..\40m\Output\Threshold\SecrecyRate_Iteration\Optimize_Trajectory\Iteration.txt','w');

%%%%%%%%%%%%%%%%%%%%%%%%%% - SecrecyRate_Time - %%%%%%%%%%%%%%%%%%%%%%%%%%%
fid_SecrecyRate = fopen('..\40m\Output\SecrecyRate_Time\Optimize_Trajectory\Secrecy_Rate.txt','w');%
fid_Time = fopen('..\40m\Output\SecrecyRate_Time\Optimize_Trajectory\Time.txt','w');

fid_x_1 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\x_1.txt','w');
fid_y_1 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\y_1.txt','w');
fid_ht_1 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\ht_1.txt','w');
fid_x_2 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\x_2.txt','w');
fid_y_2 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\y_2.txt','w');
fid_ht_2 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\ht_2.txt','w');
fid_x_3 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\x_3.txt','w');
fid_y_3 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\y_3.txt','w');
fid_ht_3 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\ht_3.txt','w');
fid_x_4 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\x_4.txt','w');
fid_y_4 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\y_4.txt','w');
fid_ht_4 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\ht_4.txt','w');
fid_x_5 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\x_5.txt','w');
fid_y_5 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\y_5.txt','w');
fid_ht_5 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\ht_5.txt','w');
fid_x_6 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\x_6.txt','w');
fid_y_6 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\y_6.txt','w');
fid_ht_6 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\ht_6.txt','w');
fid_x_7 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\x_7.txt','w');
fid_y_7 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\y_7.txt','w');
fid_ht_7 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\ht_7.txt','w');
fid_x_8 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\x_8.txt','w');
fid_y_8 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\y_8.txt','w');
fid_ht_8 = fopen('..\40m\Output\Trajectory\Optimize_Trajectory\ht_8.txt','w');

fid_PowerSource_1 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Power_Source_1.txt','w');
fid_TimeSlot1_1 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Time_Slot1.txt','w');
fid_PowerSource_2 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Power_Source_2.txt','w');
fid_TimeSlot1_2 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Time_Slot2.txt','w');
fid_PowerSource_3 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Power_Source_3.txt','w');
fid_TimeSlot1_3 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Time_Slot3.txt','w');
fid_PowerSource_4 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Power_Source_4.txt','w');
fid_TimeSlot1_4 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Time_Slot4.txt','w');
fid_PowerSource_5 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Power_Source_5.txt','w');
fid_TimeSlot1_5 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Time_Slot5.txt','w');
fid_PowerSource_6 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Power_Source_6.txt','w');
fid_TimeSlot1_6 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Time_Slot6.txt','w');
fid_PowerSource_7 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Power_Source_7.txt','w');
fid_TimeSlot1_7 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Time_Slot7.txt','w');
fid_PowerSource_8 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Power_Source_8.txt','w');
fid_TimeSlot1_8 = fopen('..\40m\Output\Power_Source\Optimize_Trajectory\Time_Slot8.txt','w');

fid_PowerUAV_1 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Power_UAV_1.txt','w');
fid_TimeSlot2_1 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Time_Slot1.txt','w');
fid_PowerUAV_2 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Power_UAV_2.txt','w');
fid_TimeSlot2_2 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Time_Slot2.txt','w');
fid_PowerUAV_3 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Power_UAV_3.txt','w');
fid_TimeSlot2_3 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Time_Slot3.txt','w');
fid_PowerUAV_4 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Power_UAV_4.txt','w');
fid_TimeSlot2_4 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Time_Slot4.txt','w');
fid_PowerUAV_5 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Power_UAV_5.txt','w');
fid_TimeSlot2_5 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Time_Slot5.txt','w');
fid_PowerUAV_6 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Power_UAV_6.txt','w');
fid_TimeSlot2_6 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Time_Slot6.txt','w');
fid_PowerUAV_7 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Power_UAV_7.txt','w');
fid_TimeSlot2_7 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Time_Slot7.txt','w');
fid_PowerUAV_8 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Power_UAV_8.txt','w');
fid_TimeSlot2_8 = fopen('..\40m\Output\Power_UAV\Optimize_Trajectory\Time_Slot8.txt','w');


fid_Rate_1 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Rate_1.txt','w');
fid_TimeSlot3_1 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Time_Slot1.txt','w');
fid_Rate_2 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Rate_2.txt','w');
fid_TimeSlot3_2 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Time_Slot2.txt','w');
fid_Rate_3 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Rate_3.txt','w');
fid_TimeSlot3_3 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Time_Slot3.txt','w');
fid_Rate_4 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Rate_4.txt','w');
fid_TimeSlot3_4 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Time_Slot4.txt','w');
fid_Rate_5 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Rate_5.txt','w');
fid_TimeSlot3_5 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Time_Slot5.txt','w');
fid_Rate_6 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Rate_6.txt','w');
fid_TimeSlot3_6 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Time_Slot6.txt','w');
fid_Rate_7 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Rate_7.txt','w');
fid_TimeSlot3_7 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Time_Slot7.txt','w');
fid_Rate_8 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Rate_8.txt','w');
fid_TimeSlot3_8 = fopen('..\40m\Output\Rate\Optimize_Trajectory\Time_Slot8.txt','w');

fid_Distance_1 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Distance_1.txt','w');
fid_TimeSlot4_1 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Time_Slot1.txt','w');
fid_Distance_2 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Distance_2.txt','w');
fid_TimeSlot4_2 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Time_Slot2.txt','w');
fid_Distance_3 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Distance_3.txt','w');
fid_TimeSlot4_3 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Time_Slot3.txt','w');
fid_Distance_4 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Distance_4.txt','w');
fid_TimeSlot4_4 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Time_Slot4.txt','w');
fid_Distance_5 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Distance_5.txt','w');
fid_TimeSlot4_5 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Time_Slot5.txt','w');
fid_Distance_6 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Distance_6.txt','w');
fid_TimeSlot4_6 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Time_Slot6.txt','w');
fid_Distance_7 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Distance_7.txt','w');
fid_TimeSlot4_7 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Time_Slot7.txt','w');
fid_Distance_8 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Distance_8.txt','w');
fid_TimeSlot4_8 = fopen('..\40m\Output\Distance\Optimize_Trajectory\Time_Slot8.txt','w');
